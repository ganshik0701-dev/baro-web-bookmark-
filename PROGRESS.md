...
마지막 갱신: 2026-09-26 (SEARCH-01 완료: 설계·문서·코드·실제 앱 확인. 6주차 완료 표시, 대량 삭제 모달 inert를 7주차 항목으로)

**다음 작업 (순서대로)**
1. 7주차 맨 위: 409 대량 삭제 모달 inert → 그다음 **SEARCH-04** 정렬 5종
...
- [ ] 409 대량 삭제 모달(`MassDeleteModal`)도 뒤 화면을 `inert`로 막기 (SCR-04 때 찾은 포커스 문제와 같은 원인일 수 있음)
- [x] SEARCH-01: 실시간 검색
...
- [ ] SEARCH-04: 정렬 5종 (visits_30d는 서버 집계)
  - [ ] 고정(BM-07)은 어떤 정렬에서도 맨 앞 — BM-07에서 남은 유일한 부분
- [ ] SEARCH-05: 정렬 설정 저장
- [ ] SET-01: 열기 방식
